...
class InventoryGroup(models.Model):
    created_by = models.ForeignKey(CustomUser, null=True, related_name= "invetory_groups" ,on_delete=models.SET_NULL)
    ...
    # overriding save funcs for our use
    ...
    # overriding delete funcs for our use
